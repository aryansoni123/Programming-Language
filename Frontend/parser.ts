import { Stmt, Program, BinaryExpression, Identifier, NumericLiteral, Expression, NullLiteral, VarDeclaration, AssignmentExpression } from "./ast.ts";
...
export default class Parser {   
    ...
    private parse_assign_Expr() : Expression {
        const lhs = this.parse_adictive_Expr();
